...
pub struct PpuRegs {
    ...
    pub bg2_w2_enabled: bool,
    pub bg2_w2_inverted: bool,
    pub bg2_w1_enabled: bool,
    pub bg2_w1_inverted: bool,
    pub bg1_w2_enabled: bool,
    pub bg1_w2_inverted: bool,
    pub bg1_w1_enabled: bool,
    pub bg1_w1_inverted: bool,

    // $2124    DdCc BbAa    Write Only
    //       - Enable (EFGH) and Invert (efgh) windows for BG3 (EF) and BG2 (GH)
    pub bg4_w2_enabled: bool,
    pub bg4_w2_inverted: bool,
    pub bg4_w1_enabled: bool,
    pub bg4_w1_inverted: bool,
    pub bg3_w2_enabled: bool,
    pub bg3_w2_inverted: bool,
    pub bg3_w1_enabled: bool,
    pub bg3_w1_inverted: bool,

    // $2125    LlKk JjIi    Write Only
    //       - Enable (IJKL) and Invert (ijkl) windows for OBJ (IJ) and color (KL)
    pub col_w2_enabled: bool,
    pub col_w2_inverted: bool,
    pub col_w1_enabled: bool,
    pub col_w1_inverted: bool,
    pub obj_w2_enabled: bool,
    pub obj_w2_inverted: bool,
    pub obj_w1_enabled: bool,
    pub obj_w1_inverted: bool,
    ...
    pub obj_main_enabled: bool,
    pub bg4_main_enabled: bool,
    pub bg3_main_enabled: bool,
    pub bg2_main_enabled: bool,
    pub bg1_main_enabled: bool,

    // $212D    ...O 4321    Write Only
    //       - Sub screen layer enable (#)
    pub obj_sub_enabled: bool,
    pub bg4_sub_enabled: bool,
    pub bg3_sub_enabled: bool,
    pub bg2_sub_enabled: bool,
    pub bg1_sub_enabled: bool,

    // $212E    ...O 4321    Write Only
    //       - Main screen layer window enable
    pub obj_win_main_enabled: bool,
    pub bg4_win_main_enabled: bool,
    pub bg3_win_main_enabled: bool,
    pub bg2_win_main_enabled: bool,
    pub bg1_win_main_enabled: bool,

    // $212F    ...O 4321    Write Only
    //       - Sub screen layer window enable
    pub obj_win_sub_enabled: bool,
    pub bg4_win_sub_enabled: bool,
    pub bg3_win_sub_enabled: bool,
    pub bg2_win_sub_enabled: bool,
    pub bg1_win_sub_enabled: bool,
    ...
    pub cmath_half: bool,
    pub back_cmath_enabled: bool,
    pub obj_cmath_enabled: bool,
    pub bg4_cmath_enabled: bool,
    pub bg3_cmath_enabled: bool,
    pub bg2_cmath_enabled: bool,
    pub bg1_cmath_enabled: bool,
    ...
    pub obj_interlace_enabled: bool,
    pub screen_interlace_enabled: bool,
