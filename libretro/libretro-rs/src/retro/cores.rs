...
use crate::retro::{
  ...
  device::{DevicePort, DeviceTypeId, JoypadButton},
  env::{self, Environment},
  error::{CoreError, LoadGameError},
  fs::Extensions,
  game::{GameInfo, GameType, SpecialGameInfo},
  mem::MemoryType,
  pixel::format::{ActiveFormat, ORGB1555},
  video::FrameBuffer,
};
...
macro_rules! libretro_core {
  ($core:ty) => {
    ...
    mod __libretro_rs_gen {
      ...
      use libretro_rs::retro::Instance;
      use libretro_rs::retro::Core;
      use libretro_rs::retro::device::DevicePort;
      use libretro_rs::retro::device::DeviceTypeId;
